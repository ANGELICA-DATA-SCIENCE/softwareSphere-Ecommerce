        ...
        <div class="col mb-4 d-flex justify-content-center">
            <div class="card" style="background-color: #a5d7e8; width: 100%; align-items: flex-start;">
                ...
                <div class="card-body" style="padding: 15px;">
                    <h5 class="card-title" style="font-size: 30px; margin: 0 0 10px; text-align: justify; ">${item.name}</h5>
                    <p class="card-text" style="font-size: 18px; margin: 0; text-align: justify; height: 350px;">${item.description}</p>
                </div>
