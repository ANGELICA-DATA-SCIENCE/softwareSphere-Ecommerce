...
navbar.insertAdjacentHTML("afterbegin",` 
  ...
  <nav class="navbar navbar-expand-lg">
      <div class="container-fluid">
          ...
          <button="disabled">
        <a href="../index.html">
        <img src="../Contenedores.js/assets/gray.png" alt="logo" width="150px">
        </a>
        </button>
          </div> 
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
              ...
              <ul class="navbar-nav mb-2 mb-lg-0">
                  <li class="nav-item">
                          <a class="nav-link" id="servicios" aria-current="page" href="../index.html">Inicio</a>
                      </li>
                  <li class="nav-item">
                      <a class="nav-link" id="servicios" aria-current="page" href="../paginaServicios/servicios.html">Servicios</a>
                  </li>
                  <li class="nav-item">
                      <a class="nav-link" id="acerca" href="../acercade/nosotros.html">Nosotros</a>
                  </li>
                  <li class="nav-item">
